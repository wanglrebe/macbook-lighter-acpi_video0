...
$ML_DEBUG && echo checking $acpi_dir and $kbd_dir...
while [ ! -d $acpi_dir -o ! -d $kbd_dir ]; do
    sleep 1
done
screen_max=$(cat $acpi_dir/max_brightness)
...
ML_SCREEN_MIN_BRIGHT=${ML_SCREEN_MIN_BRIGHT:-1}
